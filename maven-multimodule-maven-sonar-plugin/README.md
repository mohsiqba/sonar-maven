...
```
mvn -Dsonar.coverage.jacoco.xmlReportPaths=C:\projects\sonar-scanning-examples\maven-multimodule-maven-sonar-plugin\tests\target\site\jacoco-aggregate\jacoco.xml clean verify sonar:sonar 
```
