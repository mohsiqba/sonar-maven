# Sonar Multi-module Maven example

This project imports JaCoCo's aggregate XML report to be able to report coverage across modules as well as unit
test coverage inside the module. For a basic example see [sonar basic maven project](https://github.com/mohsiqba/sonarscanner-maven-basic/blob/master/README.md).
...
related unit tests and integration tests within module. The [`tests`](tests/pom.xml) module contains integration tests which test functionality using both modules. 
